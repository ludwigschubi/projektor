...
const Page = ({ children, navigation, route }) => {
    return (react_1.default.createElement(react_native_1.SafeAreaView, { style: Page_styles_1.PageStyleSheet.container },
        ...
        react_1.default.createElement(BottomBar_1.BottomBar, { navigate: navigation.navigate, activeIcon: route === null || route === void 0 ? void 0 : route.name })));
};
exports.Page = Page;
